...
public class ViewModel implements Observer{
	...
	public DoubleProperty tcElevators;
	...
	public ViewModel(Model m) {
		...
		tcAileron = new SimpleDoubleProperty();
		tcElevators=new SimpleDoubleProperty();
		tcRudder=new SimpleDoubleProperty();
		tcThrottle=new SimpleDoubleProperty();
		...
		isStartFlight.addListener((o,ov,nv)->m.startFlight());
		isEndFlight.addListener((o,ov,nv)->m.endFlight());
